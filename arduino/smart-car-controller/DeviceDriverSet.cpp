...
void DeviceDriverSet_RBGLED::flashLED(int count, int r, int g, int b)
{
    for(int i = 0; i < count; i++)
    {
        ...
        Serial.print(flash);
#endif
        this->DeviceDriverSet_RBGLED_Color(1, r, g, b);
        delay(100);
        this->DeviceDriverSet_RBGLED_Color(1, 0,0,0);
        delay(100);
    }
}
...
void DeviceDriverSet_ULTRASONIC::DeviceDriverSet_ULTRASONIC_Get(uint8_t &ULTRASONIC_Get /*out*/)
{
  uint16_t distance = 0;
  ...
  // Serial.print("Distance ultrasound_get(): ");
  // Serial.println(distance);
